...
+ If you still want to apply for a developer account and crate your own application, see the `auth` vignette (or the API authorization section below) for additional instructions: [https://rtweet.info/articles/auth.html](https://rtweet.info/articles/auth.html).
