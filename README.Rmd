...
Using your personal account is fine for casual use, but if you are trying to collect a lot of data it's a good idea to create your own twitter "app" and use `auth_app()`. Learn more in `vignette("auth", package = "rtweet")`.
