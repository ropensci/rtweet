...
R client for accessing Twitter's REST and stream APIs. Check out the [rtweet package documentation website](https://docs.ropensci.org/rtweet).
...
+ If you still want to apply for a developer account and create your own application, see the `auth` vignette (or the API authorization section below) for additional instructions: [https://docs.ropensci.org/rtweet/articles/auth.html](https://docs.ropensci.org/rtweet/articles/auth.html).
...
[Obtaining and using Twitter API tokens](https://docs.ropensci.org/rtweet/articles/auth.html)
...
[Quick overview of rtweet package](https://docs.ropensci.org/rtweet/articles/intro.html)
...
[Live streaming tweets data](https://docs.ropensci.org/rtweet/articles/stream.html)
...
[Troubleshooting common rtweet problems](https://docs.ropensci.org/rtweet/articles/FAQ.html)
...
language sent from the United States. *Note: `lookup_coords()` requires users have [a Google API key](https://developers.google.com/maps/documentation/javascript/tutorial)*
...
- To create your own Twitter app, follow the instructions in the
  authorization vignette on [obtaining and using access tokens](https://docs.ropensci.org/rtweet/articles/auth.html)
...
[issue](https://github.com/ropensci/rtweet/issues), please [create a
new issue](https://github.com/ropensci/rtweet/issues/new) with all
