...
+ See the `auth` vignette (or the API authorization section below) for instructions on obtaining access to Twitter's APIs: [http://rtweet.info/articles/auth.html](http://rtweet.info/articles/auth.html).

## API authorization

All users must be authorized to interact with Twitter's APIs. To become authorized, follow the instructions below to (a) make a Twitter app and then (b) create and save your access token (using one of the two authorization methods described below).
