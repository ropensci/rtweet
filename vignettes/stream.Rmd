...
#> Warning: There are errors in the requests: DuplicateRule
#> Check the returned object for more details.
```
...
rules
#>                  sent result_count
#> 1 2023-01-11 19:35:42            1
rules(rules)
#>                    id   value    tag
#> 1 1613258283833344002 #rstats rstats
```
...
```r
stream_rm_rule(ids(new_rule))
#> Error: Ids are not present. Are you sure this is a rtweet object?
```
...
#>  Found 307 records... Imported 307 records. Simplifying...
