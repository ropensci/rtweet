...
You can get them in your [developer dashboard](https://developer.twitter.com/en/portal/dashboard) after selecting your project.
...
![Screenshoot showing what to look to get the OAuth credentials](oauth2.png){width="548"}
