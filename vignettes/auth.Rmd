...
- In the `Keys and Access Tokens` tab, scroll down to `Token Actions` and click `Create my access token`. That should generate two access keys,`Access Token` and `Access Token Secret`, as shown in image below (those are fake keys btw).
