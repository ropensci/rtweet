...
# Troubleshooting common rtweet errors
...
1. If checked, uncheck `Enable callback locking` option in "Settings" tab at https://apps.twitter.com
...
#### Solutions
1. Create new token using the keys for your Twitter application found at https://apps.twitter.com
