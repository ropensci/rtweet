...
#' screen_name) for the authenticating user. The timeline returned is
#' the equivalent of the one seen when you view your mentions on
#' twitter.com. This method can only return up to 800 tweets.
#' 
#' @inheritParams get_mentions_call
...
get_mentions <- function(n = 100,
  ...
  do.call("get_mentions_call", args)
}
...
#'   console).
#' 
#' @return A tibble of mentions data.
#' @export
#' @rdname get_mentions 
get_mentions_call <- function(n = 100,
                              since_id = NULL,
                              max_id = NULL,
                              ...,
                              parse = TRUE,
