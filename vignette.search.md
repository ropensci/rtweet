...
(+1 for each instance of hillary or clinton in the text of each tweet). After doing the 
same for Donald Trump, I plotted both using `ggplot2`, which is like a cheat code for
